...
var nicEditorConfig = bkClass.extend({
	...
	buttonList : ['save','bold','italic','underline','left','center','right','justify','ol','ul','fontSize','fontFamily','fontFormat','upload','image','link','unlink','forecolor','xhtml'],
...
var nicUploadButton = nicEditorAdvancedButton.extend({	
	nicURI : 'js/nicedit/nicUpload.php',
