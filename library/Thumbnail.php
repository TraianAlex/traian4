...
class Thumbnail {
    ...
    public function create() {
       if ($this->_canProcess && $this->_originalwidth != 0) {
         ...
         //$this->_messages[] = 'Cannot determine size of ' . $this->_original;
           throw new Exception('Cannot determine size of ' . $this->_original);
       }
    }
    ...
    protected function createThumbnail() {
        ...
        if ($success) {
            ...
            //throw new Exception("$newname created successfully.");
        } else {
            //$this->_messages[] = "Couldn't create a thumbnail for " .
            //basename($this->_original);
            throw new Exception("Couldn't create a thumbnail for " .
            basename($this->_original));
        }
